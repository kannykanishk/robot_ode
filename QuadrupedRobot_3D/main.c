...
static float XYZ[3] = { 0.60, -3.26, 1.20};	// 視点の位置
static float HPR[3] = { 101 , -6.50, 0.4   };	// 視線の方向
...
static void simLoop(int pause){					// シミュレーションループ
	...
	dJointAddUniversalTorques(Joint_BL1, TorqueLegY1, TorqueLegX1);		// 脚にトルクを入力
	dJointAddSliderForce     (Joint_LS2, ForceSlider2);
	dJointAddUniversalTorques(Joint_BL2, TorqueLegY2, TorqueLegX2);
	dJointAddSliderForce     (Joint_LS3, ForceSlider3);
	dJointAddUniversalTorques(Joint_BL3, TorqueLegY3, TorqueLegX3);
	dJointAddSliderForce     (Joint_LS4, ForceSlider4);
	dJointAddUniversalTorques(Joint_BL4, TorqueLegY4, TorqueLegX4);
...
static void makeMonoBot(){
	...
	dJointSetUniversalAnchor(Joint_BL1, x0-0.15, y0-0.15, z0);
	...
	dJointSetUniversalAnchor(Joint_BL2, x0+0.15, y0-0.15, z0);
	...
	dJointSetUniversalAnchor(Joint_BL3, x0-0.15, y0+0.15, z0);
	...
	dJointSetUniversalAnchor(Joint_BL4, x0+0.15, y0+0.15, z0);
