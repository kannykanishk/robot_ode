...
static void makeMonoBot(){
	...
	Body.geom= dCreateBox(space, Body.x, Body.y, Body.z);				// Generating geometry in the box
	...
	Leg1.geom= dCreateCapsule(space, Leg1.r, Leg1.l);					// Generating the geometry of the capsule
	...
	Leg2.geom= dCreateCapsule(space, Leg2.r, Leg2.l);					// Generating the geometry of the capsule
	...
	Leg3.geom= dCreateCapsule(space, Leg3.r, Leg3.l);					// Generating the geometry of the capsule
	...
	Leg4.geom= dCreateCapsule(space, Leg4.r, Leg4.l);					// Generating the geometry of the capsule
	...
	Slider1.geom= dCreateCapsule(space, Slider1.r, Slider1.l);			// Generating the geometry of the capsule
	...
	Slider2.geom= dCreateCapsule(space, Slider2.r, Slider2.l);			// Generating the geometry of the capsule
	...
	Slider3.geom= dCreateCapsule(space, Slider3.r, Slider3.l);			// Generating the geometry of the capsule
	...
	Slider4.geom= dCreateCapsule(space, Slider4.r, Slider4.l);			// Generating the geometry of the capsule
