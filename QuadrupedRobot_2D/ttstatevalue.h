...
void cal_state_value(void) {
	...
	// Legs
	AngLegY1    = dJointGetHingeAngle(Joint_BL1);			// y-axis angle of leg1
	AngVelLegY1 = cal_d_1st_filter(9, AngLegY1, OMEGA);		// y-axis angular velocity of leg1
	
	AngLegY2    = dJointGetHingeAngle(Joint_BL2);			// y-axis angle of leg2
	AngVelLegY2 = cal_d_1st_filter(10, AngLegY2, OMEGA);	// y-axis angular velocity of leg2

	AngLegY3    = dJointGetHingeAngle(Joint_BL3);			// y-axis angle of leg3
	AngVelLegY3 = cal_d_1st_filter(11, AngLegY3, OMEGA);	// y-axis angular velocity of leg3

	AngLegY4    = dJointGetHingeAngle(Joint_BL4);			// y-axis angle of leg4
	AngVelLegY4 = cal_d_1st_filter(12, AngLegY4, OMEGA);	// y-axis angular velocity of leg4

	// Sliders
	PosSlider1 = dJointGetSliderPosition(Joint_LS1);		// Position of slider 1
	VelSlider1 = cal_d_1st_filter(13, PosSlider1, OMEGA);	// Velocity of slider 1

	PosSlider2 = dJointGetSliderPosition(Joint_LS2);		// Position of slider 2
	VelSlider2 = cal_d_1st_filter(14, PosSlider2, OMEGA);	// Velocity of slider 2

	PosSlider3 = dJointGetSliderPosition(Joint_LS3);		// Position of slider 3
	VelSlider3 = cal_d_1st_filter(15, PosSlider3, OMEGA);	// Velocity of slider 3

	PosSlider4 = dJointGetSliderPosition(Joint_LS4);		// Position of slider 4
	VelSlider4 = cal_d_1st_filter(16, PosSlider4, OMEGA);	// Velocity of slider 4
