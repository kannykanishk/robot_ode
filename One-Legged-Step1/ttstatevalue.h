...
void cal_state_value(void){
	...
	// 脚の状態量
	AngLegY    = dJointGetHingeAngle(Joint_BL);				// 脚の角度
	AngVelLegY = cal_d_1st_filter(3, AngLegY, OMEGA);		// 脚の角速度
	AngLegX    = dJointGetHingeAngle(Joint_BL);				// 脚の角度
	AngVelLegX = cal_d_1st_filter(11, AngLegX, OMEGA);		// 脚の角速度
